...
public class Main {
    static final int MAX = 503; // max h. w

    static boolean[][] valid = new boolean[MAX][MAX]; // valid[][] = true일 경우, 해당 위치는 물이 고일 수 있음
    ...
    public static void main(String[] args) throws IOException {
        ...
        int h = Integer.parseInt(st.nextToken()), w = Integer.parseInt(st.nextToken()); // 1 ≤ h, w ≤ 500
